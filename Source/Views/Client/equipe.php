    ...
    <div class="container">
      <ul class="equipe">
        ...
        <li class="equipe-item">
          ...
          <h3>Edryelle Maria</h3>
          <div class="desc">
            Prof(a) de Sociologia, Filosofia, e História
          </div>
        ...
        <li class="equipe-item">
          ...
          <h3>Lucia da Silva</h3>
          <div class="desc">
            Prof(a) de Sociologia, Filosofia e Geografia
          </div>
